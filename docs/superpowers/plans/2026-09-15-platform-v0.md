...
**Tech Stack:** Next.js 16.3.5, React 19, shadcn 4.21 (Tailwind), BetterAuth 1.7.5 with `emailOTP`, Drizzle ORM 0.45.2 + drizzle-kit 0.31.10, `pg` 8.23, `@electric-sql/pglite` 0.5.8, `resend` 6.28, `jsonwebtoken` 9, `tsx`, vitest, Fly Machines API, GitHub Actions.

**Spec:** `docs/superpowers/specs/2026-09-15-platform-v0-design.md`

## Global Constraints

- Every UI element is a shadcn component or composed from shadcn components. No other component library, no hand-rolled buttons, inputs, tables, cards, badges or alerts.
...
```bash
npx shadcn@4.21.0 init -y -t next -b radix
npx shadcn@4.21.0 add -y button card input label table badge alert separator dropdown-menu
ls src/components/ui
```

Expected: `button.tsx card.tsx input.tsx label.tsx table.tsx badge.tsx alert.tsx separator.tsx dropdown-menu.tsx`.
