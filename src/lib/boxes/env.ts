...
export function boxEnv(profile: BoxProfile, s: BoxSecrets, jwtSecret: string, ownerEmail: string): Record<string, string> {
  const base = { BOX_PROFILE: profile, JWT_SECRET: jwtSecret, CLAUDE_CODE_OAUTH_TOKEN: s.claudeToken, OWNER_EMAIL: ownerEmail };
